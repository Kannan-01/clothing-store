...
function Footer() {
  return (
    <div className='d-flex mt-5 justify-content-center align-items-center flex-column bg-primary text-dark' style={{width:'100%',height:'400px'}}>
      <div className='footer-content d-flex justify-content-evenly w-100 flex-wrap'>
        <div className='website d-flex flex-column'>
        <h4><i className="fa-solid fa-truck-fast me-2" style={{color: '#ffffff'}}></i>{' '} E Kart</h4>
<h6>
...
<h6>Currently v1.0.0.</h6>
        ...
        <div className='contact d-flex flex-column flex-wrap'>
            ...
            <Link to={'/'} className='mx-2' style={{textDecoration:'none',color:'white'}}><i class="fa-brands fa-tiktok" style={{textDecoration:'none',color:'white'}}></i></Link>
            <Link to={'/'} className='mx-2' style={{textDecoration:'none',color:'white'}}><i class="fa-brands fa-github" style={{textDecoration:'none',color:'white'}}></i></Link>

            </div>
        </div>

      </div>
      <p className='mt-5'>Copyright © 2023 E Kart. Built with React.</p>
    </div>
  )
}
